...
def get_standard_train_test_split(df, test_ratio=0.2, is_not_time_series = True):
    ...
    X_train, X_test, y_train, y_test = train_test_split(X, y, test_size=test_ratio, random_state=RANDOM_STATE, shuffle = is_not_time_series)
